...
这个好像不太行。要制作n个动图；难道不要有图？没有图我在说什么可能自己都不知道，并且写着写着，我找到了一篇分析动森动效极其细致的[文章](https://mp.weixin.qq.com/s/thtl8hHnQNbYx1ZuUXkY9g)[^1]
所以略过
{:.side-note}
...
![screenshot](/assets/images/posts/220626/03-1.png)
![screenshot](/assets/images/posts/220626/04-1.png)
> 前⬆️后⬇️

![screenshot](/assets/images/posts/220626/03-2.png)
![screenshot](/assets/images/posts/220626/04-2.png)

><font size=2>哇 24年的我现在再看这个升级UI的迭代 真是难以想象怎么会把前面的版本留这么久（
...
[^1]:[这个动森动效分析得细致动人呐](https://mp.weixin.qq.com/s/thtl8hHnQNbYx1ZuUXkY9g)

[^2]:[明日方舟版本更新公告](https://ak.hypergryph.com/news/2022066772.html)
